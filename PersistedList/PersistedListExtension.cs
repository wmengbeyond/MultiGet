...
using Imgo.MultiGet.Instrumentation;

namespace Imgo.MultiGet.PersistedList
{
    public class PersistedListExtension: /*IExtension, */IDisposable //wm 
    {
        [Serializable]
        ...
        {
            //string file = Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath) + "\\" + "downloads.xml";//wm
            string file = "downloads.xml";
            return file;
        }
